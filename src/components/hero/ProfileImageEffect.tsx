...
const ProfileImageEffect = ({
  ...
  const ringWidth = 8; // Width of the glowing ring in pixels

  return (
    <div
      className={`relative ${className || ''} w-full max-w-[420px] mx-auto`}
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 20px 10px rgba(255, 0, 255, 0.3), 0 0 40px 20px rgba(0, 255, 255, 0.2)',
          filter: 'blur(15px)',
        }}
        animate={{
